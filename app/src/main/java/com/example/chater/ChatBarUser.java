...
public class ChatBarUser extends LinearLayout {
     ...
     * *************/
    public ChatBarUser(Context context) {
        this(context,null);
    }

    public ChatBarUser(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ChatBarUser(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mView = inflater.inflate(R.layout.chat_bar_user,this, true);

        contentTextView = (TextView) mView.findViewById(R.id.chat_bar_user_contentText);
        headImgView = (ImageView) mView.findViewById(R.id.chat_bar_user_headImg);
        contentLayout = (LinearLayout) mView.findViewById(R.id.chat_bar_user_contentLayout);
